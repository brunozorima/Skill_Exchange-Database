...
GO
ALTER TABLE [dbo].[Exchange] DROP CONSTRAINT [FK__Exchange__Sender__571DF1D5];
...
GO
ALTER TABLE [dbo].[Exchange] DROP CONSTRAINT [FK__Exchange__Recipi__5812160E];
...
GO
ALTER TABLE [dbo].[ExchangeMessage] DROP CONSTRAINT [FK__ExchangeM__Excha__5AEE82B9];
...
GO
ALTER TABLE [dbo].[ExchangeMessage] DROP CONSTRAINT [FK__ExchangeM__Sende__5BE2A6F2];
...
ALTER TABLE [dbo].[Exchange] WITH NOCHECK
    ADD FOREIGN KEY ([Sender_Id]) REFERENCES [dbo].[ApplicationUser] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Exchange] WITH NOCHECK
    ADD FOREIGN KEY ([Recipient_Id]) REFERENCES [dbo].[ApplicationUser] ([Id]) ON DELETE CASCADE;
