...
GO
ALTER TABLE [dbo].[ExchangeMessage] DROP CONSTRAINT [FK__ExchangeM__Sende__47DBAE45];
...
GO
ALTER TABLE [dbo].[ExchangeMessage] DROP CONSTRAINT [FK__ExchangeM__Excha__48CFD27E];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_ExchangeMessage] ([Id], [Sender_Id], [Exchange_Id], [Body], [TimeStamp])
        SELECT   [Id],
                 [Sender_Id],
                 [Exchange_Id],
                 [Body],
